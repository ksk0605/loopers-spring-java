...
@Table(
    ...
    indexes = {
        @Index(name = "idx_weekly_period_rank", columnList = "period_key, version, rank"),
        @Index(name = "idx_weekly_period_product", columnList = "period_key, version, product_id")
    }
)
public class MvProductRankWeekly {
    ...
    public MvProductRankWeekly(String periodKey, String version, Integer rank, Long productId) {
